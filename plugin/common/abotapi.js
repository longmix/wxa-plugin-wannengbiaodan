...
var abot_data = require('../abot_data.js');

module.exports = {
  globalData: abot_data.globalData,
 ...
 /**
  ...
  set_option_list_str: function (callback_function) {
    ...
    if (wx.getStorageSync('shop_option_list_str_' + this.get_sellerid()) && (currentTime - wx.getStorageSync("option_list_str_time")) < 3600 * 1000) {
      ...
      //刷新界面
      typeof callback_function == "function" && callback_function(option_list);
    ...
    if (wx.getStorageSync("o2o_basic_data_option_str") && (currentTime - wx.getStorageSync("o2o_basic_data_option_str_time")) < 3600 * 1000) {
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          console.log('保存商城选项 get_basic_data_option ：' + o2o_basic_data_option_str);
